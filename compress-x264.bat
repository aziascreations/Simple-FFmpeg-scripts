...
echo FFmpeg compress with x264
...
echo * Command: %FFMPEG% -i "%1" -vcodec libx264 %FFMPEG_VERBOSE_COMMAND% -crf %FFMPEG_CRF_X26X% "%~d1%~p1%~n1.cx264.mp4"
...
:convert
echo.
%FFMPEG% -i "%1" -vcodec libx264 %FFMPEG_VERBOSE_COMMAND% -crf %FFMPEG_CRF_X26X% "%~d1%~p1%~n1.cx264.mp4"
goto end
