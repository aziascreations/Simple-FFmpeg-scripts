...
echo * Command: %FFMPEG% -i "%1" -vcodec libx264 %FFMPEG_VERBOSE_COMMAND% -crf 24 "%~d1%~p1%~n1.cx264.mp4"
...
:convert
echo.
%FFMPEG% -i "%1" -vcodec libx264 %FFMPEG_VERBOSE_COMMAND% -crf 24 "%~d1%~p1%~n1.cx264.mp4"
goto end
